...
const ProgressSteps = ({ status }) => {
    ...
    return (
        <div className="flex items-center justify-between" role="progressbar" aria-valuenow={currentIndex + 1} aria-valuemin="0" aria-valuemax={steps.length}>
                ...
                return (
                    <div key={step.key} className="flex flex-col items-center flex-1">
                        <div
                            ...
                            aria-label={`${step.label} ${isCompleted ? 'completed' : isActive ? 'active' : 'pending'}`}
                        >
