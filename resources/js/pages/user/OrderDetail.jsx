...
export default function OrderDetail() {
    ...
    const handleConfirmOrder = async () => {
        if (!confirm("Yakin ingin mengkonfirmasi pesanan ini sebagai selesai?"))
            return;
                        ...
                        <span
                            className={`px-4 py-2 rounded-full text-sm font-semibold ${
                                loading
                                    ...
                                    : getStatusColor(displayOrder.status)
                            }`}
                        >
                            {loading
                                ? "Memuat..."
                                ...
                                {displayOrder.order_items.map((item) => (
                                    ...
                                    >
                                        <img
                                            src={
                                                loading
                                                    ? "data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iOTYiIGhlaWdodD0iMTI4IiB2aWV3Qm94PSIwIDAgOTYgMTI4IiBmaWxsPSJub25lIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPgo8cmVjdCB3aWR0aD0iOTYiIGhlaWdodD0iMTI4IiBmaWxsPSIjRTVFNUI1Ii8+Cjwvc3ZnPgo="
                                                    : item.book.image_url ||
                            ...
                            >
                                ...
                                <div className="space-y-2">
                                    ...
                                    >
                                        {loading
                                            ? "Memuat..."
                                            : `${displayOrder.shipping_address.city}, ${displayOrder.shipping_address.province} ${displayOrder.shipping_address.postal_code}`}
                                    </p>
                                </div>
                            </div>
                        )}
                        ...
                        >
                            ...
                            <div className="space-y-3 mb-6">
                                <div className="flex justify-between text-gray-700 dark:text-gray-300">
                                    <span>Subtotal</span>
                                    <span>
                                         {loading || !displayOrder.total_price
                                            ? "Rp 0"
                                            : `Rp ${Math.round(
                            ...
                            {displayOrder.status === "pending" && (
                                <div className="space-y-3">
                                    <button
                                        ...
                                        } text-white px-4 py-3 rounded-lg transition font-semibold`}
                                    >
                                        {loading
                                            ? "Memuat..."
                                            : "Bayar Sekarang"}
                                    ...
                                    <button
                                        ...
                                        } px-4 py-3 rounded-lg transition font-semibold`}
                                    >
                                        <XCircle
                                            className={`w-5 h-5 ${
