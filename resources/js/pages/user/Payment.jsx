...
export default function Payment() {
    ...
    const loadSnapScript = () => {
        ...
        script.setAttribute('data-client-key', import.meta.env.VITE_MIDTRANS_CLIENT_KEY || 'Mid-client-Vf8NgZIDyCcELaga');
    ...
    if (loading) {
        return (
            <div className="flex flex-col justify-center items-center min-h-screen">
                ...
                <p className="text-gray-600 dark:text-gray-400">Memuat pembayaran...</p>
            </div>
        );
    }
        ...
        <div className="max-w-2xl mx-auto px-4 py-16 text-center">
            ...
            <div className="mt-8 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
                ...
                <div className="text-left space-y-2">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                        <span className="font-medium">Total:</span> Rp {order?.total_price.toLocaleString('id-ID')}
                    </p>
                    <p className="text-gray-700 dark:text-gray-300">
